...
CREATE TABLE IF NOT EXISTS `mydb`.`job` (
  ...
  `experience_length_months` INT NULL,
  `experience_detail` VARCHAR(45) NULL,
  `is_alternance` TINYINT NULL,
  `is_disabled_friendly` TINYINT NULL,
  `naf_code` VARCHAR(10) NULL,
  `qualification_code` INT NULL,
  `candidates_missing` TINYINT NULL,
  `activity_sector_code` INT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`job_contract` (
  ...
  `work_condition` VARCHAR(45) NULL,
  `additional_condition` VARCHAR(45) NULL,
